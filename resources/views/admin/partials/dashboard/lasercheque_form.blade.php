    ...
    <div class="mt-3">
        ...
        <div class="modal fade" id="modalManualCheque" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <form
                    action="{{ isset($chequesCategory) ? route('update.laser.cheque', $chequesCategory->id) : route('store.laser.cheque') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle">
                                {{ isset($chequesCategory) ? 'Edit Laser Cheque' : 'Add Laser Cheque' }}
                            </h5>
