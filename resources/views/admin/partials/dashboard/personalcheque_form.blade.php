    ...
    <div class="mt-3">
        ...
        <div class="modal fade" id="modalManualCheque" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <form
                    action="{{ isset($chequesCategory) ? route('update.personal.cheque', $chequesCategory->id) : route('store.personal.cheque') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle">
                                {{ isset($chequesCategory) ? 'Edit Personal Cheque' : 'Add Personal Cheque' }}
                            </h5>
