...
<div class="row">
    <div id="navBreadCrumb"> <a href="{{ url('admin') }}">Home</a>&nbsp;<span class="separator">//</span>&nbsp;
        <a href="{{ url('admin/personalcheques') }}">Personal Cheques</a>&nbsp;<span class="separator">
        </span>&nbsp;
    </div>
    <div class="col-3"></div>
    <div class="col-6">
        <h3 class="text-center my-4">Personal Cheques</h3>
        <div class="card mb-4">
            <div class="card-body">
                <form method="post" action="{{ route('store.personal.cheque') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
