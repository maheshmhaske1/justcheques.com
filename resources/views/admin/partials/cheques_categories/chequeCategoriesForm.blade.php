                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="manual_cheque_id"
                                        id="manual_cheque_id"
                                        value="{{ old('manual_cheque_id', $chequeCategoryData->manual_cheque_id ?? '') }}"
                                        required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="laser_cheque_id"
                                        id="laser_cheque_id"
                                        value="{{ old('laser_cheque_id', $chequeCategoryData->laser_cheque_id ?? '') }}"
                                        required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="personal_cheque_id"
                                        id="personal_cheque_id"
                                        value="{{ old('personal_cheque_id', $chequeCategoryData->personal_cheque_id ?? '') }}"
                                        required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="chequeName" id="chequeName"
                                        value="{{ old('chequeName', $chequeCategoryData->chequeName ?? '') }}"
                                        required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="price"
                                        id="price" value="{{ old('price', $chequeCategoryData->price ?? '') }}"
                                        required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if (isset($chequeCategoryData) && $chequeCategoryData->img)
                                        <a href="{{ asset('assets/front/img/' . $chequeCategoryData->img) }}"
                                            target="_blank">{{ $chequeCategoryData->img }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="resetChequesCategories" class="btn btn-outline-secondary"
