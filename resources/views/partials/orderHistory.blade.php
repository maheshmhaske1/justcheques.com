                                ...
                                <table class="table order-history-table test" style="width: 100%; min-width: 1500px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="customer_datils" style="width: 250px;">Customer Deatils</th>
                                            <th class="shipping-to" style="width: 250px;">Company Deatils</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="shipping-to">
                                                ...
                                                <strong>Company:</strong>
                                                 ...
                                                 <strong>Country:</strong> {{ $order->customerDetails->country ?? 'N/A' }}
                                                @else
                                                N/A
                                                @endif
                                            </td>
